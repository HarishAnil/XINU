...
/* Default # of queue entries: 1 per process plus 2 for system processes ready list plus	*/
/*			2 for sleep list plus 2 for user processes ready list plus 2 per semaphore		*/
#ifndef NQENT
#define NQENT	(NPROC + 12 + NSEM + NSEM)
#endif
